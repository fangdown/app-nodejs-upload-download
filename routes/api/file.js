...
const chunkDir = path.join(__dirname, "../../resources/chunktemp");
const fileInfoDir = path.join(__dirname, "../../resources/filetemp");
const fileDir = path.join(__dirname, "../../resources/file");
